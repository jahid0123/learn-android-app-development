package com.jmjbrothers.androidservicebrodcastreceiverapp;
...
import com.jmjbrothers.androidservicebrodcastreceiverapp.service.MyBackgroundService;

public class MainActivity extends AppCompatActivity {

    private static final String  TAG = "MainActivity";
    private static String CUSTOM_BROADCAST_ACTION = "com.jmjbrothers.studentcrud.CUSTOM_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sendBroadcastButton  = findViewById(R.id.broadcast);
